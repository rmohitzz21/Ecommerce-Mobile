                    ...
                    <div class="card-body--">
                        <div class="table-stats order-table ov-h">
                            ...
                            <div id="address_details">
                                <strong style="padding: 10px;margin:10px;">Address</strong>
                                <?php echo $address ?>, <?php echo $city ?>, <?php echo $pincode ?><br /><br />
                                <strong style="padding: 10px;margin:10px;">Order Status</strong>
                                <?php
                                ...
                                <div>
                                    <form method="post">
                                        ...
                                        <input type="submit" class="form-control submit" style="background-color:aqua;"  />
