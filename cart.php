										...
										if(isset($_SESSION['cart'])){
											...
											<tr>
												...
												<td class="product-name"><a href="#"><?php echo $pname?></a>
													<ul  class="pro__prize">
														<del><li class="old__prize">₹<?php echo $mrp?></li></del>
												...
												<br/><a href="javascript:void(0)" onclick="manage_cart('<?php echo $key?>','update')" style="background-color:grey;  font-size: 20px; margin: top 3px "; >update</a>
												</td>
